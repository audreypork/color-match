...
type AppState = "intro" | "upload" | "results" | "palette" | "matcher";
...
export default function Home() {
  ...
  const runnerUpKeys = topKey
    ? (Object.keys(seasons) as SeasonKey[])
  ...
  return (
    <div className="relative min-h-screen" style={{ background: "var(--bg)" }}>
      ...
      <main className="relative z-10 max-w-2xl mx-auto px-4 py-10 sm:py-16">
        {/* Header — hidden on palette/matcher to save space */}
        {appState !== "palette" && appState !== "matcher" && (
          ...
          <div>
            ...
            <div className="space-y-5">
              <SeasonResult
                ...
                onViewPalette={() => setAppState("palette")}
                onCheckItem={() => setAppState("matcher")}
              />
